...
if (headerbuilders !== undefined){
    ...
    console.log(` Time:${process.argv[4]}秒`);
    console.log(` Threads/speed:${process.argv[6]}/${process.argv[5]}`);
    console.log(` Random number:${process.argv[7]}`);
    console.log(` Random number/english:${result}`);
    console.log(` Agents:${proxies_total + 2} HttpProxy `);
    console.log(` Ua.txt:${ua_total + 2} Ua head `);
    ...
    console.log(` Random number:${process.argv[7]}`);
    console.log(` Random number/english:${result}`);
    console.log(` Number of agents:${proxies_total + 2} HttpProxy `);
    console.log(` Ua.txt:${ua_total + 2} Ua head `);
    console.log("CREATED BY MR.X4ND3R")
